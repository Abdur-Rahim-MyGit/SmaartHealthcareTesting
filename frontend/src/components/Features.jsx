...
const features = [
    {
        ...
        description: "Access to highly qualified and experienced healthcare professionals across various specialties.",
        color: "blue"
    },
    {
        icon: <FaCalendarAlt />,
    ...
    },
    {
        icon: <FaMobileAlt />,
        title: "Mobile App",
        description: "Manage your appointments and medical records from your smartphone.",
        color: "orange"
    },
    {
        icon: <FaLock />,
        title: "Secure Records",
        description: "Your medical data is protected with industry-standard security measures.",
        color: "red"
    },
    {
        icon: <FaClock />,
