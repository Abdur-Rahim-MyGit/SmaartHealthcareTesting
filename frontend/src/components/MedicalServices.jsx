...
const services = [
  ...
  { icon: <FaBrain className="w-8 h-8" />, name: 'Neurology', color: 'purple' },
  { icon: <MdChildCare className="w-8 h-8" />, name: 'Pediatrics', color: 'pink' },
  { icon: <AiOutlineEye className="w-8 h-8" />, name: 'Ophthalmology', color: 'green' },
  { icon: <IoIosFitness className="w-8 h-8" />, name: 'Orthopedics', color: 'orange' },
  ...
  { icon: <RiMentalHealthLine className="w-8 h-8" />, name: 'Mental Health', color: 'rose' }
];
